...
public class AuthController {
    ...
    public ResponseEntity login (@RequestBody @Valid AuthDTO authDTO) {
        var userPwd = new UsernamePasswordAuthenticationToken(authDTO.username(), authDTO.password());
    ...
    public ResponseEntity register (@RequestBody @Valid RegisterDTO registerDTO) {
        ...
        String encryptedPwd = new BCryptPasswordEncoder().encode(registerDTO.password());
        System.out.println("SENHA: " + encryptedPwd);
        User newUser = new User(registerDTO.username(), encryptedPwd, registerDTO.role());
